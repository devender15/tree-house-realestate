      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
            ...
            <span className="block text-teal-600 mt-2">Your Dream Investment Awaits</span>
          </h2>

          <p className="text-gray-600 text-lg lg:text-xl max-w-2xl mx-auto leading-relaxed">
            Discover exclusive commercial, residential, farmhouse and farmland opportunities
          </p>
        </div>
            ...
            {[
              {
                ...
                description: "Premium office spaces and luxury homes in prime locations",
                imageUrl: "url('/assets/commercial_bg.png')"
              },
              {
                icon: MapPin,
                title: "Farmhouse & Farmlands",
                description: "Newly added exclusive farmhouse properties and agricultural lands",
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700 font-medium">+91 9811098193</span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-teal-100 rounded-lg flex items-center justify-center">
                    <Mail className="w-5 h-5 text-teal-600" />
                  </div>
                  <span className="text-gray-700 font-medium text-sm break-all">Treehousefarmland@gmail.com</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <a
                ...
                className="flex items-center justify-center gap-3 bg-emerald-600 hover:bg-emerald-700 text-white py-3 px-4 rounded-xl font-medium transition-colors duration-300 w-full"
              >
              ...
              <Link
                href={"/enquiry"}
                className="group w-full bg-teal-600 hover:bg-teal-700 text-white px-4 py-3 rounded-xl font-medium transition-all duration-300 flex items-center justify-center gap-2"
              >
